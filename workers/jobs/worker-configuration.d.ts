/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/jobs/wrangler.jsonc --strict-vars=false --env-interface=JobsBindings workers/jobs/worker-configuration.d.ts` (hash: b160b62a3ee43de68e0993d050419845)
// Runtime types generated with workerd@1.20260911.1 2026-09-11 nodejs_compat
interface __BaseEnv_JobsBindings {
	...
	INGEST_SOURCE: Workflow<Parameters<import("./src/index").IngestSourceWorkflow['run']>[0]['payload']>;
	GENERATE_DRAFT: Workflow<Parameters<import("./src/index").GenerateDraftWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	...
	interface Env extends __BaseEnv_JobsBindings {}
}
interface JobsBindings extends __BaseEnv_JobsBindings {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INGESTION_SCHEDULE_ENABLED" | "INGESTION_WRITES_ENABLED" | "GENERATION_ENABLED" | "CLOSURE_MAX_FRACTION" | "CLOSURE_MAX_COUNT">> {}
}
