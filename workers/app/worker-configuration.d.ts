/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/app/wrangler.jsonc workers/app/worker-configuration.d.ts` (hash: 989b0905a4f91c211050796689e69be7)
...
interface __BaseEnv_Env {
	...
	EMAIL?: SendEmail;
	ASSETS: Fetcher;
	APP_ORIGIN: "https://staging.invalid" | "https://production.invalid" | "http://localhost:8787";
	MAIL_MODE: "disabled";
	MAIL_FROM: "no-reply@auth.lakefrontdev.com" | "";
	WRITES_ENABLED: "false";
	GENERATION_ENABLED: "false";
	GENERATION_DAILY_LIMIT: "5";
	GENERATION_INFLIGHT_LIMIT: "2";
	MCP_ENABLED: "false";
...
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		EMAIL: SendEmail;
		ASSETS: Fetcher;
		APP_ORIGIN: "https://production.invalid";
		MAIL_MODE: "disabled";
		MAIL_FROM: "no-reply@auth.lakefrontdev.com";
		WRITES_ENABLED: "false";
		GENERATION_ENABLED: "false";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "MAIL_MODE" | "MAIL_FROM" | "WRITES_ENABLED" | "GENERATION_ENABLED" | "GENERATION_DAILY_LIMIT" | "GENERATION_INFLIGHT_LIMIT" | "MCP_ENABLED" | "MCP_WRITES_ENABLED" | "MCP_GENERATION_ENABLED" | "MCP_REVIEW_ENABLED">> {}
}
